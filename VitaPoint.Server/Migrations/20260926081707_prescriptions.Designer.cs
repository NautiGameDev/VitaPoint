...
namespace VitaPoint.Server.Migrations
{
    ...
    [Migration("20260926081707_prescriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VitaPoint.Server.Models.Lab", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VitaPoint.Server.Models.LabComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LabComponents");
                });

            modelBuilder.Entity("VitaPoint.Server.Models.LabResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VitaPoint.Server.Models.LabComponent", b =>
                {
                    b.HasOne("VitaPoint.Server.Models.LabResult", null)
                        .WithMany("Components")
            ...
            modelBuilder.Entity("VitaPoint.Server.Models.LabResult", b =>
                {
                    b.HasOne("VitaPoint.Server.Models.Lab", "Lab")
                        .WithMany()
                        .HasForeignKey("LabId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
